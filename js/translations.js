...
window.I18N = {
  en: {
    ...
    'skill.frontend.desc': 'Accessible, responsive interfaces built with modern JavaScript tooling.',
    'skill.backend.title': 'Backend',
    'skill.backend.desc': 'Robust server-side logic, clean APIs, and maintainable OOP.',
    'skill.drupal.title': 'Drupal Development',
    'skill.drupal.desc': 'My deepest area — custom back-end logic the Drupal way.',
    'skill.site.title': 'Drupal Site Building & Theming',
    'skill.site.desc': 'Editor-friendly content models and component-driven themes.',
    'skill.data.title': 'Databases & Caching',
    'skill.data.desc': 'Well-modeled data and smart caching for fast, reliable apps.',
    'skill.decoupled.title': 'Decoupled & APIs',
    'skill.decoupled.desc': 'Headless back ends feeding modern JavaScript front ends.',
    'skill.devops.title': 'DevOps & Tooling',
    'skill.devops.desc': 'Reliable local-to-production workflows with automated builds.',
    ...
    /* certs */
    'certs.title': 'Certifications & Community',
    'certs.sub': 'Credentialed, and active where the community actually lives.',
    ...
    'cert3.title': 'Drupal.org Contributor',
    'cert3.desc': 'Maintainer of a utility module; patches reviewed on two contrib projects.',
    'cert4.title': 'DrupalCon & Camp Speaker',
    'cert4.desc': '"Decoupled Drupal, one year in" — regional Drupal Camp 2024.',
    ...
    'testi.q3': '"The best kind of senior: writes clean code across the stack, documents it, and leaves the codebase easier to work in than he found it."',
    'testi.q3role': 'Engineering Lead, Northlane',
    ...
    'contact.note': 'Usually replies within a day. Based in Casablanca, Morocco · GMT+1.',
  ...
  fr: {
    ...
    'skill.frontend.title': 'Frontend',
    'skill.frontend.desc': 'Des interfaces accessibles et responsives, avec un outillage JavaScript moderne.',
    'skill.backend.title': 'Backend',
    'skill.backend.desc': 'Une logique serveur robuste, des API propres et une POO maintenable.',
    'skill.drupal.title': 'Développement Drupal',
    'skill.drupal.desc': 'Mon domaine de prédilection — de la logique back-end faite « à la Drupal ».',
    'skill.site.title': 'Site Building & Thématisation Drupal',
    'skill.site.desc': "Des modèles de contenu pensés pour les éditeurs et des thèmes orientés composants.",
    'skill.data.title': 'Bases de données & Cache',
    'skill.data.desc': 'Des données bien modélisées et un cache intelligent pour des apps rapides et fiables.',
    'skill.decoupled.title': 'Découplé & APIs',
    'skill.decoupled.desc': 'Des back-ends headless qui alimentent des front-ends JavaScript modernes.',
    'skill.devops.title': 'DevOps & Outils',
    'skill.devops.desc': 'Des workflows fiables du local à la production, avec des builds automatisés.',
    ...
    /* certs */
    'certs.title': 'Certifications & Communauté',
    'certs.sub': 'Certifié, et actif là où la communauté vit vraiment.',
    'cert1.title': 'Acquia Certified Drupal Developer',
    'cert1.desc': 'Développement back-end & modules de niveau expert.',
    'cert2.title': 'Acquia Certified Site Builder',
    'cert2.desc': 'Modélisation de contenu, Views et configuration.',
    'cert3.title': 'Contributeur Drupal.org',
    'cert3.desc': "Mainteneur d'un module utilitaire ; correctifs revus sur deux projets contrib.",
    'cert4.title': 'Conférencier DrupalCon & Camp',
    'cert4.desc': '« Decoupled Drupal, one year in » — Drupal Camp régional 2024.',
    ...
    'testi.q3': "« Le meilleur type de senior : du code propre sur toute la stack, documenté, et une base de code plus agréable qu'à son arrivée. »",
    'testi.q3role': 'Lead technique, Northlane',
    ...
    'contact.note': "Répond généralement sous 24 h. Basé à Casablanca, Maroc · GMT+1.",
