...
window.I18N = {
  en: {
    ...
    'hero.prefix': 'I work as a',
    'hero.intro': 'I design complete web applications, end to end — polished interfaces, robust back ends — with a specialization in Drupal, PHP & Next.js.',
    'hero.viewProjects': 'View Projects',
    'hero.downloadCv': 'Download CV',
    'hero.metaYears': '+ years of experience',
    'hero.metaSites': '<strong>11+</strong> projects delivered',
    'term.role': 'Full-Stack Developer · Drupal Specialist',
    'term.stack': 'JS · React · Next.js · PHP · Drupal · SQL',

    /* about */
    'about.title': 'About Me',
    'about.p1': "For the past <strong><span data-years-since=\"2023\">3</span> years I have been building web applications</strong> with a full-stack approach, specializing in <strong>Drupal & PHP as my core expertise</strong>. I like owning a feature end to end: the data model, the API, and the interface on top of it.",
    'about.p2': "My strength is turning functional requirements into clear, robust, and maintainable solutions — from the front end with Next.js, Twig, and Tailwind CSS, to the back end with PHP, Drupal, or Laravel, including fully decoupled architectures built on Next.js. When a project calls for deep Drupal expertise — custom modules, performance tuning, or complex migrations — that's where I add the most value.",
    ...
    'skill.drupal.title': 'Drupal Development',
    'skill.drupal.desc': 'Custom Drupal 8/9/10/11 modules, services, hooks, plugins, form & entity APIs...',
    'skill.apis.title': 'Headless Architectures & RESTful APIs',
    'skill.apis.desc': 'RESTful API design and integration, headless architectures with JSON:API, GraphQL, React, and Next.js.',
    'skill.frontend.title': 'Modern & Responsive User Interfaces',
    'skill.frontend.desc': 'Modern, performant, and responsive UIs built with Next.js, React, Tailwind CSS, Alpine.js, and Sass.',
    'skill.devops.title': 'DevOps Environments & CI/CD',
    'skill.devops.desc': 'Containerized environments (Docker, Podman), CI/CD pipelines, OpenShift, ArgoCD, SonarQube, and deployments.',
    'skill.arch.title': 'Performance & Software Architecture',
    'skill.arch.desc': 'Robust software architecture design, performance optimization, and code quality with SonarQube, PHPStan, PHPUnit, etc.',
    'skill.backend.title': 'Backend Engineering',
    'skill.backend.desc': 'Robust server-side logic, object-oriented programming, PHP 8.x, and the Symfony / Laravel / Drupal ecosystem.',
    // 'skill.data.title': 'Databases & Data Layer',
    // 'skill.data.desc': 'Database modeling (MySQL, Oracle, PostgreSQL), ETL migration processes, and data integrity.',
    ...
    'testi.q1role': 'Product Manager, Private Sector',
    ...
    /* footer */
    'footer.tag': 'Full-Stack Developer · Drupal specialist · at your service.',
    /* rotator words */
  ...
  fr: {
    ...
    'hero.intro': "Je conçois des applications web complètes, de bout en bout — interfaces soignées, back-ends robustes — avec une spécialisation en Drupal & PHP & Next.js.",
    'hero.viewProjects': 'Voir les projets',
    'hero.downloadCv': 'Télécharger le CV',
    'hero.metaYears': "+ ans d'expérience",
    'hero.metaSites': '<strong>11+</strong> projets livrés',
    'term.role': 'Développeur Full-Stack · Spécialiste Drupal',
    'term.stack': 'JS · React · Next.js · PHP · Drupal · SQL',

    /* about */
    'about.title': 'À propos',
    'about.p1': "Depuis <strong><span data-years-since=\"2023\">3</span> ans, je développe des applications web</strong>, avec une approche full-stack et <strong>Drupal/PHP comme spécialisation principale</strong>. J’aime prendre en charge une fonctionnalité de bout en bout : du modèle de données à l’API, jusqu’à l’interface utilisateur.",
    'about.p2': "Mon point fort : transformer des besoins fonctionnels en solutions claires, robustes et maintenables — du front-end avec Next.js, Twig et Tailwind CSS au back-end avec PHP, Drupal ou Laravel, jusqu’aux architectures découplées basées sur Next.js. Lorsqu’un projet nécessite une expertise Drupal approfondie (modules sur mesure, performance, migrations...), je mets particulièrement cette expertise à profit.",    'about.focus1': 'Développement full-stack de fonctionnalités',
    'about.focus2': 'Modules & architectures Drupal',
    'about.focus3': 'Projets découplés / Headless',
    'about.focus4': 'Performance & qualité du code',
    ...
    'about.valAvail': 'Immédiate',

    /* expertise */
    'expertise.title': 'Expertise',
    'expertise.sub': 'Un profil full-stack — avec une spécialisation en Drupal.',
    'skill.specialty': 'Spécialité',
    'skill.drupal.title': 'Développement Drupal',
    'skill.drupal.desc': 'Drupal 8/9/10/11 sur mesure, services, hooks, plugins, APIs formulaires et entités...',
    ...
    'skill.devops.desc': 'Environnements conteneurisés (Docker, Podman), pipelines CI/CD, OpenShift, ArgoCD, SonarQube et déploiements.',
    'skill.arch.title': 'Performance & Architecture logicielle',
    'skill.arch.desc': "Conception d'architectures logicielles robustes, optimisation des performances et qualité de code avec SonarQube, PHPStan, PHPUnit, etc.",
    'skill.backend.title': 'Ingénierie Back-end',
    'skill.backend.desc': 'Logique serveur robuste, programmation orientée objet (POO), PHP 8.x et écosystème Symfony / Laravel / Drupal.',
    ...
    'proj2.solution': "Back-end Drupal 10 avec une couche API REST consommée par un front-end Next.js.",
    ...
    'testi.q1role': 'Chef de produit, secteur privé',
    'testi.q4': "« J’ai eu le plaisir de travailler avec Salah chez VOID. C’est un développeur Full Stack rigoureux, avec une excellente maîtrise de PHP et Drupal. Il propose des solutions fiables et bien structurées. Un excellent professionnel et collaborateur. »",
    'testi.q4role': 'Technical Lead @ VOID · Drupal & Next.js',
